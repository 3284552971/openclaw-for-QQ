...
{"group_id":"1000000003","limit":50}

# 下载文件（优先用 url）
POST /file/download
{"url":"https://.../paper.pdf","group_id":"1000000003","user_id":"1000000001"}
...
# 仅有 file_id 时先换直链
POST /get_file_url
{"target":"group","group_id":"1000000003","file_id":"/xxxx-xxxx"}

# 发文字到群
POST /send_text
{"target":"group","group_id":"1000000003","text":"总结结果..."}

# 发文字到私聊
POST /send_text
{"target":"private","user_id":"1000000001","text":"私聊结果..."}

# 发送 Word 文件（.docx）
POST /send_file
{"target":"group","group_id":"1000000003","path":"./data/downloads/files/summary_20260209_101500.docx"}
```
